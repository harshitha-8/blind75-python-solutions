...
- ⬜ Number of Connected Components - Medium (Premium)
...
### 1. Hash Map / Hash Set
**Used for O(1) lookups to avoid nested loops**
- Two Sum
- Contains Duplicate
- Group Anagrams

### 2. Two Pointers
**Navigate array from both ends or use fast/slow pointers**
- 3Sum
...
### 4. Tracking Min/Max
**Keep track of running minimum or maximum**
